...
public class CategoryRESTController {
    ...
    @GetMapping("/search")
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<List<Category>> findCategoriesByCriteria(@RequestBody @NotNull FindCategoriesByCriteria findCategoriesCriteria) {
        ...
        return ResponseEntity.ok(categoryService.findCategoriesByExample(category));
        }
        catch(IllegalArgumentException e) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "None of the existent categories matches with this searching crieteria ", e);
        }
    }
