...
public class ProductRESTController {
    ...
    @GetMapping("/search")
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<List<Product>> findProductsByCriteria(@RequestBody @NotNull FindProductsByCriteria findProductsCriteria) {
        ...
        return ResponseEntity.ok(productService.findProductsByExample(product));
        }
        catch(IllegalArgumentException e) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "None of the existent products matches with this searching crieteria ", e);
        }
